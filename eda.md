...
Suppose you want to summarize many columns `across` is to list multiple
things across same function
...
**min_rank helps rank things and “min_rank(desc(tmax))) = opposite order
...
lag: shift over data across and one (can identify how much you wanna
move down by)
